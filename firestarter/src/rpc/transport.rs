...
impl RPCPacket for InternalPacket {}

#[derive(Debug)]
/// Represents an RPC request.
pub enum Request<Packet: RPCPacket> {
    /// The request has some packet.
    Some(Packet),
}

impl<Packet: RPCPacket> Request<Packet> {
...
pub enum Response<Packet: RPCPacket> {
    /// The response has some packet.
    Some(Packet),
}

impl<Packet: RPCPacket> Response<Packet> {
